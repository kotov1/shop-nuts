				...
				<div class="col-xl-6 col-lg-7">
					<div class="about__text wow fadeInLeft" data-wow-duration="1s">
						...
						<div class="advantages__text">
							<p>Наши достоинства: </p>
							<p>Мы поставляем кедровый орех прямо из Сибири. Поэтому у нас он всегда свежий. За неделю перед отправкой к Вам его перерабатывают.</p>
							<p>Герметичная упаковка: 6 месяцев сохраняет полезность продукта.</p>
							<p>У нас быстрая доставка, в тот же день или на следующий, в противном случае доставим заказ бесплатно!</p>
							<p>Если товар Вас не устроит, мы вернём Вам деньги.</p>
						</div>
					</div> <!-- /.about__text -->
				</div> <!-- /.col -->
			...
			<div class="row no-gutters">
				...
				<div class="col-xl-6 col-lg-7 order-xl-2 order-1">
					<div class="about__text pt-10 wow fadeInRight" data-wow-duration="1s">
						...
						<p>Покупка кедрового ореха в нашем интернет-магазине поможет Вашему здоровью. Орешек станет надёжным помощником в борьбе с лишним весом и при этом не содержит холестерина. Кедровый орех оказывает положительное влияние на умственное и физическое развитие детей. Высокая калорийность кедровых орехов нисколько не мешает похуданию: даже 100 грамм такого продукта приносят ощущение сытости на весь день.</p>
					</div> <!-- /.about__text -->
				</div> <!-- /.col -->
